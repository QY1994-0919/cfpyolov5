...
def convert_annotation(year, image_id):
    ...
    in_file = open('/opt/data/private/voc/VOCdevkit/VOC%s/Annotations/%s.xml'%(year, image_id))
    out_file = open('/opt/data/private/voc/VOCdevkit/VOC%s/labels/%s.txt'%(year, image_id), 'w')
...
for year, image_set in sets:
    ...
    if not os.path.exists('/opt/data/private/voc/VOCdevkit/VOC%s/labels/'%(year)):
        os.makedirs('/opt/data/private/voc/VOCdevkit/VOC%s/labels/'%(year))
    #image_ids = open('VOCdevkit/VOC%s/ImageSets/Main/%s.txt'%(year, image_set)).read().strip().split()
    image_ids = open('/opt/data/private/voc/VOCdevkit/VOC%s/ImageSets/Main/%s.txt'%(year, image_set)).read().strip().split()
    list_file = open('%s_%s.txt'%(year, image_set), 'w')
    for image_id in image_ids:
        #list_file.write('%s/VOCdevkit/VOC%s/JPEGImages/%s.jpg\n'%(wd, year, image_id))
        list_file.write('%s/opt/data/private/voc/VOCdevkit/VOC%s/JPEGImages/%s.jpg\n'%(wd, year, image_id))
...
outfile = '/root/qy/yolov5-master1/train.txt'
mergeTxt(file_list, outfile)
file_list= ['2007_train.txt', '2007_val.txt', '2007_test.txt', '2012_train.txt', '2012_val.txt']
outfile = '/root/qy/yolov5-master1/train.all.txt'
mergeTxt(file_list, outfile)

# 创建VOC文件夹及子文件夹
wd = os.getcwd()
#data_base_dir = os.path.join(wd, "VOC/")
data_base_dir = os.path.join(wd, "/opt/data/private/voc/VOC/")
...
#f = open('train.txt', 'r')
print(os.path.exists('/root/qy/yolov5-master1/train.txt'))
f = open('/root/qy/yolov5-master1/train.txt', 'r')
lines = f.readlines()
...
for line in lines:
    ...
    if (os.path.exists(line)):
        ...
        shutil.copy(line, "/opt/data/private/voc/VOC/images/train") # 复制图片
    ...
    if (os.path.exists(line)):
        ...
        shutil.copy(line, "/opt/data/private/voc/VOC/labels/train")
...
print(os.path.exists('/root/qy/yolov5-master1/2007_test.txt'))
f = open('/root/qy/yolov5-master1/2007_test.txt', 'r')
lines = f.readlines()
...
for line in lines:
    ...
    if (os.path.exists(line)):
        ...
        shutil.copy(line, "/opt/data/private/voc/VOC/images/val") # 复制图片
    ...
    if (os.path.exists(line)):
        ...
        shutil.copy(line, "/opt/data/private/voc/VOC/labels/val") # 复制label

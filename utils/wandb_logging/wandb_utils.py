...
def process_wandb_config_ddp_mode(opt):
    ...
    if data_dict['train'].startswith(WANDB_ARTIFACT_PREFIX):
        ...
        train_path = Path(train_dir) / '/home/10102006/dataset/coco17/images/train2017/'
    ...
    if data_dict['val'].startswith(WANDB_ARTIFACT_PREFIX):
        ...
        val_path = Path(val_dir) / '/home/10102006/dataset/coco17/images/val2017/'
    ...
    def setup_training(self, opt, data_dict):
        ...
        if 'val_artifact' not in self.__dict__:  # If --upload_dataset is set, use the existing artifact, don't download
            ...
            if self.train_artifact_path is not None:
                train_path = Path(self.train_artifact_path) / '/home/10102006/dataset/coco17/images/train2017/'
                data_dict['train'] = str(train_path)
            if self.val_artifact_path is not None:
                val_path = Path(self.val_artifact_path) / '/home/10102006/dataset/coco17/images/val2017/'
                data_dict['val'] = str(val_path)
